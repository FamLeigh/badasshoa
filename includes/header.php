...
function nav_icon(string $name): string
{
    ...
    switch ($name) {
        ...
        case 'listings':       return "<svg $base><path d='M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z'/><polyline points='9 22 9 12 15 12 15 22'/></svg>";
        case 'attractions':    return "<svg $base><circle cx='12' cy='12' r='10'/><line x1='2' y1='12' x2='22' y2='12'/><path d='M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z'/></svg>";
        case 'amenities':      return "<svg $base><rect x='3' y='4' width='18' height='18' rx='2' ry='2'/><line x1='16' y1='2' x2='16' y2='6'/><line x1='8' y1='2' x2='8' y2='6'/><line x1='3' y1='10' x2='21' y2='10'/><path d='M9 16l2 2 4-4'/></svg>";
...
function active_nav_key(): string
{
    ...
    static $map = [
        ...
        '/dashboard/amenities.php'         => 'amenities',
    ...
    <div class="side-nav__inner">
        ...
        <?php if ($page_layout === 'app'): ?>
            ...
            <?php ob_start(); ?>
                ...
                <?php endif; ?>
                <?php if (can_do('book_amenity')): ?>
                    <?= nav_link('/dashboard/amenities.php', 'amenities', 'Book Amenity', 'amenities', $active) ?>
                <?php endif; ?>
